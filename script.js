...
style.textContent = `
    ...
    .delete-memory-btn:hover {
        background: linear-gradient(90deg, #8a2be2, #00f5ff);   transform: scale(1.1);
    }
    #close-memory-btn {
        margin-top: 25px;
        padding: 12px 30px;
    ...
    #add-memory-btn {
        padding: 10px 20px; border-radius: 8px; border: none; background: linear-gradient(90deg, #8a2be2, #00f5ff);
        color: white; cursor: pointer; font-weight: bold; transition: background 0.2s;
    }
    #add-memory-btn:hover { background: linear-gradient(90deg, #8a2be2, #00f5ff); }
    #memory-btn {
        margin-left: 2px;
    }
...
memoryBtn.addEventListener("click", () => {
	loadMemoryPanel();
	document.getElementById("memory-panel").classList.add("visible");
});
